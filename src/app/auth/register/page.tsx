    ...
    if (success) {
        return (
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900">
                <div className="w-full max-w-md p-8 space-y-6 bg-zinc-900/80 backdrop-blur-lg rounded-2xl border border-zinc-800 shadow-2xl text-center">
                    <div className="w-16 h-16 mx-auto bg-green-500/20 rounded-full flex items-center justify-center">
                        <svg className="w-8 h-8 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                        </svg>
                    </div>
                    <h1 className="text-2xl font-serif font-bold text-white">Бүртгэл амжилттай!</h1>
                    <p className="text-zinc-400">
                        Бид таны имэйл рүү баталгаажуулах линк илгээлээ.
                        Имэйлээ шалгаад линк дээр дарна уу.
                    </p>
                    <Link
                        href="/auth/login"
                        className="inline-block py-3 px-6 bg-gradient-to-r from-amber-600 to-amber-500 hover:from-amber-500 hover:to-amber-400 text-white font-semibold rounded-lg transition-all"
                    >
        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900">
            <div className="w-full max-w-md p-8 space-y-6 bg-zinc-900/80 backdrop-blur-lg rounded-2xl border border-zinc-800 shadow-2xl">
                <div className="text-center">
                    ...
                    <p className="text-zinc-400 mt-2">Шинэ бүртгэл үүсгэх</p>
                </div>
                ...
                <form onSubmit={handleRegister} className="space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            minLength={8}
                        />
                        <p className="text-xs text-zinc-500 mt-1">Хамгийн багадаа 8 тэмдэгт</p>
                    </div>
